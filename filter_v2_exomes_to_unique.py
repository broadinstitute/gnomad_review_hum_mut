...
def main(args):
    ...
    ht = ht.annotate(v2_genomes_adj_freq = v2_genomes_ht[ht.locus,ht.alleles].freq[freq_adj_idx])
    ...
    ht = ht.annotate(v3_non_v2_adj_freq = v3_genomes_ht[ht.liftover_locus,ht.liftover_alleles].freq[freq_adj_idx])
