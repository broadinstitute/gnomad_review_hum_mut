...
def main(args):
    ...
    ht.export("gs://gnomad-wphu/review-hum-mut/samples_with_variants.tsv.bgz", header=True, overwrite=True)
    #ht_summary.write("gs://gnomad-wphu/review-hum-mut/samples_with_variants_summary.ht", overwrite= True)
    #ht_summary.export("gs://gnomad-wphu/review-hum-mut/samples_with_variants_summary.tsv.bgz", header=True, overwrite=True)
